...
<meta name="description" content="Vibrante-Node v2.1.1 — {title}">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Vibrante-Node v2.1.1 — Documentation</title>
<style>{PORTAL_CSS}
...
<main class="content">
  <div class="content-inner">
    <div class="hero">
      ...
      <span class="version-badge">v2.1.1 Documentation</span>
    </div>
    {cards_by_group}
  </div>
</main>
